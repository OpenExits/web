"""/api/v1/validate (dry-run) and /api/v1/objects/nearby — the wizard's live
...
def objects_nearby():
    ...
    hits = nearby.objects_near(current_app.config["COMMONS_REPO_PATH"], g.db, lat, lon, radius)
