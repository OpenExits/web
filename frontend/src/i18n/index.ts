...
i18n.use(initReactI18next).init({
  resources: {
    en: { common: enCommon, home: enHome, object: enObject, wizard: enWizard, moderation: enModeration, terms: enTerms },
    fr: { common: frCommon, home: frHome, object: frObject, wizard: frWizard, moderation: frModeration, terms: frTerms },
  },
  lng: initialLocale(),
  fallbackLng: "en",
  defaultNS: "common",
